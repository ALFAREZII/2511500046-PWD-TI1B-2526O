...
<body>
  ...
  <main>
    ...
    <?php if ( !empty($flash_sukses) ): ?>
        <div style="padding:10px; margin-bottom:10px; background:#04edda; color:#155724; border-radius:6px;">
            <?= $flash_sukses; ?>
        </div>
    <?php endif; ?>
...
<label for="txtCaptcha"><span>Buktikan Anda bukan robot ( 59 - 34 + 44 - 2 = ?):</span>
