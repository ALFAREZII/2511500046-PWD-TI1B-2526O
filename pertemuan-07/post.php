  ...
  <body>
    ...
    <main>
      ...
      <section id="about">
        ...
        $tanggallahir = "07 Agustus 2007";
        $hobby = "Bermain Game, Aragement musik , Bermain Instrument &#127926;";
        $pasangan = "Tidak ada karena kurang sigma &hearts;";
        $pekerjaaan = "Tidak ada";
        $namaorangtua = "Ema Asmalinar dan Saanis Djanan";
        $kakak = "Tidak ada";
        $adik = "Tidak ada";
        ?>
        <h2>Tentang Saya</h2>
